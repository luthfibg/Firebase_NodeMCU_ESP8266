...
#define FIREBASE_HOST "testesp8266-36c7c-default-rtdb.firebaseio.com" //--> URL address of your Firebase Realtime Database.
#define FIREBASE_AUTH "WkxXg5nR2GD89cRjkuokGRa79XUdvqMXzxEesrqv" //--> Your firebase database secret code.

#define ON_Board_LED 2  //--> Defining an On Board LED, used for indicators when the process of connecting to a wifi router

//----------------------------------------SSID and Password of your WiFi router.
const char* ssid = "Nugroho Family"; //--> Your wifi name or SSID.
const char* password = "17312809"; //--> Your wifi password.
//----------------------------------------
